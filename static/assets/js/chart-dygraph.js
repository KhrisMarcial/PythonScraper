// Darken a color
	  ...
	  colors:
            ["#60529f", "#f95058", "#32cafe", "#fc0", "#22c03c", "#60529f", "#60529f",
             "#60529f", "#60529f", "#60529f", "#60529f", "#60529f", "#60529f", "#60529f",
             "#60529f", "#60529f", "#60529f"];
      ...
      function candlePlotter(e) {
        ...
        for (p = 0 ; p < prices.length; p++) {
          ...
          if (price.open > price.close) {
            ctx.fillStyle ='rgb(96, 82, 159)';
            bodyY = area.h * price.openY + area.y;
          }
          else {
            ctx.fillStyle ='rgba(50, 202, 254,1.0)';
